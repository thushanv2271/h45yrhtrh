...
//        var result = await response.Content.ReadFromJsonAsync<CreateBranchResponse>();
...
//        // Assert
//        response.StatusCode.Should().Be(HttpStatusCode.OK);
//        var result = await response.Content.ReadFromJsonAsync<List<BranchResponse>>();
//        result.Should().NotBeNull();
...
//    {
//        // Arrange
//        var org1 = await CreateTestOrganizationAsync("Org1", "ORG1");
//        var org2 = await CreateTestOrganizationAsync("Org2", "ORG2");
...
//        // Assert
//        response.StatusCode.Should().Be(HttpStatusCode.OK);
//        var result = await response.Content.ReadFromJsonAsync<BranchResponse>();
//        result.Should().NotBeNull();
...
//        // Arrange
//        var organization = await CreateTestOrganizationAsync();
//        var branch = await CreateTestBranchAsync(organization.Id, "Old Name", "OB001");
...
//        // Verify in database
//        var updatedBranch = await DbContext.Branches
//            .AsNoTracking()
...
//        // Arrange
//        var organization = await CreateTestOrganizationAsync();
//        var branch1 = await CreateTestBranchAsync(organization.Id, "Branch 1", "BR001", "branch1@test.com");
//        var branch2 = await CreateTestBranchAsync(organization.Id, "Branch 2", "BR002", "branch2@test.com");
...
//        // Arrange
//        var organization = await CreateTestOrganizationAsync();
//        var branch = await CreateTestBranchAsync(organization.Id, "Test Branch", "TB001", "test@branch.com");
...
//        var deletedBranch = await DbContext.Branches
//            .FirstOrDefaultAsync(b => b.Id == branch.Id);
...
//        var branch3 = await CreateTestBranchAsync(organization.Id, "Branch 3", "BR003");
...
//        var remainingBranches = await DbContext.Branches.ToListAsync();
...
//        var createResponse = await HttpClient.PostAsJsonAsync(BaseUrl, createRequest);
//        createResponse.StatusCode.Should().Be(HttpStatusCode.OK);
//        var created = await createResponse.Content.ReadFromJsonAsync<CreateBranchResponse>();
//        created!.BranchId.Should().NotBeEmpty();

//        // Get All Branches
//        var getAllResponse = await HttpClient.GetAsync(BaseUrl);
//        getAllResponse.StatusCode.Should().Be(HttpStatusCode.OK);
//        var allBranches = await getAllResponse.Content.ReadFromJsonAsync<List<BranchResponse>>();
//        allBranches.Should().ContainSingle();

//        // Get By Id
//        var getByIdResponse = await HttpClient.GetAsync($"{BaseUrl}/{created.BranchId}");
//        getByIdResponse.StatusCode.Should().Be(HttpStatusCode.OK);
//        var retrievedBranch = await getByIdResponse.Content.ReadFromJsonAsync<BranchResponse>();
...
//        var updateResponse = await HttpClient.PutAsJsonAsync($"{BaseUrl}/{created.BranchId}", updateRequest);
//        updateResponse.StatusCode.Should().Be(HttpStatusCode.OK);

//        // Verify Update
//        var getAfterUpdate = await HttpClient.GetAsync($"{BaseUrl}/{created.BranchId}");
//        var updatedBranch = await getAfterUpdate.Content.ReadFromJsonAsync<BranchResponse>();
//        updatedBranch!.BranchName.Should().Be("Updated Workflow Branch");
//        updatedBranch.Email.Should().Be("updated.workflow@branch.com");

//        // Delete Branch
//        var deleteResponse = await HttpClient.DeleteAsync($"{BaseUrl}/{created.BranchId}");
//        deleteResponse.StatusCode.Should().Be(HttpStatusCode.OK);

//        // Verify Delete
//        var getAfterDelete = await HttpClient.GetAsync(BaseUrl);
//        var branchesAfterDelete = await getAfterDelete.Content.ReadFromJsonAsync<List<BranchResponse>>();
...
//        var org1 = await CreateTestOrganizationAsync("Org 1", "ORG1");
//        var org2 = await CreateTestOrganizationAsync("Org 2", "ORG2");
...
//        // Filter by org1
//        var org1Response = await HttpClient.GetAsync($"{BaseUrl}?organizationId={org1.Id}");
//        var org1Branches = await org1Response.Content.ReadFromJsonAsync<List<BranchResponse>>();
//        org1Branches.Should().HaveCount(2);
//        org1Branches.Should().AllSatisfy(b => b.OrganizationId.Should().Be(org1.Id));

//        // Filter by org2
//        var org2Response = await HttpClient.GetAsync($"{BaseUrl}?organizationId={org2.Id}");
//        var org2Branches = await org2Response.Content.ReadFromJsonAsync<List<BranchResponse>>();
